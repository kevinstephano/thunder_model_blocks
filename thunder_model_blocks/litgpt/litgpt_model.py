...
if __name__ == "__main__":
    ...
    def grads(dtype, batch_size=cfg.batch_size, seq_len=cfg.seq_len):
        grad = torch.randn(batch_size, seq_len, cfg.padded_vocab_size, device='cuda', dtype=dtype, requires_grad=False)
        return grad

    runner.run(sys_argv, cfg.name_or_path, cfg, MyModel, inputs, module_has_loss=False, grad_fn=grads)
