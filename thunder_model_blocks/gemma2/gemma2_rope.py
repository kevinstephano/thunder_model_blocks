...
from thunder_model_blocks.gemma2 import gemma2_config
...
class Gemma2Rope(torch.nn.Module):
...
if __name__ == "__main__":
    ...
    runner.run(sys.argv, cfg.name_or_path, cfg, Gemma2Rope, inputs, module_has_loss=False, grad_fn=grads)
